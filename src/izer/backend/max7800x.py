        ...
        with console.Progress(start=True) as progress:
            ...
            while ll < layers:
                ...
                if operator[ll] in [op.CONV2D, op.LINEAR]:
                    ...
                    # Attention is implemented using pointwise convolutions
                    ...
                    # Layer norm is implemented using pointwise operations
                    ...
                    # Feed-forward is implemented using two linear layers
                ...
                elif operator[ll] == op.POSITIONAL_ENCODING:
                    # Positional encoding is pre-computed
                    out_buf, out_size = positional_encoding_layer(
                        ll,
                        data.shape,
                        kernel[kernel_ptrs[ll]],
                        data,
                    ...
                    # Residual connection is implemented using element-wise addition
